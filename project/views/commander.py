...
def commander():
    ...
    plats_chauds = Plats.get_plats_filtered_by_type_and_allergenes(
        "Plat chaud", selected_allergenes)
    plats_froids = Plats.get_plats_filtered_by_type_and_allergenes(
        "Plat froid", selected_allergenes)
    sushis = Plats.get_plats_filtered_by_type_and_allergenes(
        "Sushi", selected_allergenes)
    formules = Formule.get_formules_filtered_by_allergenes(selected_allergenes)
    desserts = Plats.get_plats_filtered_by_type_and_allergenes(
        "Dessert", selected_allergenes)
...
def filter_allergenes():
    ...
    resp = make_response(
        render_template("commander.html",
                        plats=plats,
                        plats_chauds=plats_chauds,
                        plats_froids=plats_froids,
                        sushis=sushis,
